...
Thank you for contacting me regarding your wedding on {{date("l jS \of F Y",$booking["timestamp"])}}.  I have pleasure in confirming my availability and providing you with a quotation for your event.<br><br>

To provide a wedding DJ between {{$booking["start_time_formatted"]}} and {{$booking["finish_time_formatted"]}} at {{$booking["venue_name"]}}, {{$booking["venue_postcode"]}} would be £{{$booking["total_cost"]}}.<br><br>
...
To place a booking and secure the date, simply <a href="{{ config('app.url') . 'booking/' . $booking['email_token'] }}">click here</a>.<br><br>
